...
# -*- coding: utf-8 -*-
#
# slacksound documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''slacksound''')])
...
version = slacksound.__version__
# The full version, including alpha/beta/rc tags.
release = slacksound.__version__
...
htmlhelp_basename = '''slacksounddoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''slacksound.tex''',
     u'''slacksound Documentation''',
